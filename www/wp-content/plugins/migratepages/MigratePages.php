<?php
/*
 * Plugin Name: Migrate Pages Plugin Plugin URI: http://github.com/rhildred/gitwordpress/ Description: Export pages into git, and import them Author: Rich Hildred Version: 1.0 Author URI: http://syndicateme.net/
 */
class MigratePages {
